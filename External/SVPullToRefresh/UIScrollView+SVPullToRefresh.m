...
- (id)initWithFrame:(CGRect)frame {
    if(self = [super initWithFrame:frame]) {
        ...
        self.textColor = [UIColor verizonBlack];
        self.arrowColor = [UIColor verizonBlack];
        self.activityIndicatorView.color = [UIColor verizonBlack];
        self.autoresizingMask = UIViewAutoresizingFlexibleWidth;
        self.state = SVPullToRefreshStateStopped;
        self.showsDateLabel = NO;
        
        self.titles = [NSMutableArray arrayWithObjects:NSLocalizedString(@"Pull to load more...",),
                             NSLocalizedString(@"Release to load more...",),
                             NSLocalizedString(@"Loading more...",),
                                nil];
...
- (UILabel *)titleLabel {
    if(!_titleLabel) {
        ...
        _titleLabel.font = [UIFont fontWithName:kSTIPoCFontHelveticaNeueLight size:16.0];
...
- (void)drawRect:(CGRect)rect {
	...
	CGContextAddRect(context, CGRectMake(5, 12, 12, 4));
	
    CGContextMoveToPoint(context, 5, 19);
    CGContextAddLineToPoint(context, 5, 23);
    CGContextAddLineToPoint(context, 0, 23);
    CGContextAddLineToPoint(context, 11, 37);
    CGContextAddLineToPoint(context, 22, 23);
    CGContextAddLineToPoint(context, 17, 23);
